/**
 * @component slider · stock: shadcn base-luma
 * @regen     pnpm ui:add slider
 * @frost     none
 * @delta     ~ thumb hover/focus ring lightened: ring-4 ring-ring/30 → ring-2 ring-ring/20; system-wide calmer focus
 */
