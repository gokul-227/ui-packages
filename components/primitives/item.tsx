/**
 * @component item · stock: shadcn base-luma
 * @regen     pnpm ui:add item
 * @frost     none
 * @delta     ~ focus ring lightened: ring-[3px] ring-ring/50 → ring-2 ring-ring/20; system-wide calmer focus
 */
...
const itemVariants = cva(
  "group/item flex w-full flex-wrap items-center rounded-2xl border text-sm outline-none transition-colors duration-100 focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/20 [a]:transition-colors [a]:hover:bg-muted",
  {
    variants: {
      variant: {
