...
// Deltas from shadcn's field:
// - a vertical field stacks at `gap-2`, not `gap-3`. A label belongs to the
//   control under it, and at 12px it read as a sibling of the description below
//   instead. Rows keep 12px, which is the gap between a control and its label
  ...
  "group/field flex w-full data-[invalid=true]:text-destructive",
  {
    variants: {
      orientation: {
        ...
        responsive:
          "@md/field-group:flex-row flex-col @md/field-group:items-center @md/field-group:gap-3 gap-2 *:w-full @md/field-group:*:w-auto @md/field-group:has-[>[data-slot=field-content]]:items-start @md/field-group:*:data-[slot=field-label]:flex-auto [&>.sr-only]:w-auto @md/field-group:has-[>[data-slot=field-content]]:[&>[role=checkbox],[role=radio]]:mt-px",
      },
    },
    defaultVariants: {
