/**
 * @component toggle · stock: shadcn base-luma
 * @regen     pnpm ui:add toggle
 * @frost     none
 * @delta     ~ focus ring lightened: ring-[3px] ring-ring/30 → ring-2 ring-ring/20; system-wide calmer focus
 */
"use client";
