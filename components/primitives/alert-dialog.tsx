/**
 * @component alert-dialog · stock: shadcn base-luma
 * @regen     pnpm ui:add alert-dialog
 * @frost     surface — AlertDialogContent (Popup) uses the `frosted` material
 * @delta     ~ AlertDialogContent: bg-popover → frosted (translucent fill + backdrop blur)
  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Popup
        className={cn(
          "group/alert-dialog-content frosted data-open:fade-in-0 data-open:zoom-in-95 data-closed:fade-out-0 data-closed:zoom-out-95 fixed top-1/2 left-1/2 z-50 grid w-full -translate-x-1/2 -translate-y-1/2 gap-6 rounded-4xl p-6 text-popover-foreground outline-none ring-1 ring-foreground/5 duration-100 data-[size=default]:max-w-xs data-[size=sm]:max-w-xs data-closed:animate-out data-open:animate-in data-[size=default]:sm:max-w-md dark:ring-foreground/10",
          className
        )}
        data-size={size}
